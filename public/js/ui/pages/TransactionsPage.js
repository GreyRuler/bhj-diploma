...
class TransactionsPage {
    ...
    registerEvents() {
        ...
        removeAccountButton.addEventListener('click', this.removeAccountHandler)
    }
    ...
    clear() {
        ...
        this.element.querySelector('.remove-account')
            .removeEventListener('click',  this.removeAccountHandler)
    }
    ...
    renderTransactions(data) {
        ...
        const removeTransactionButtons = content.querySelectorAll(
            '.transaction__remove'
        )
        removeTransactionButtons.forEach(element => {
